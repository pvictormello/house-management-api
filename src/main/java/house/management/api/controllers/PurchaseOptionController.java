...
public class PurchaseOptionController {
    ...
    public PurchaseOptionController(PurchaseOptionService purchaseOptionService, ItemService itemService, MetadataService metadataService, UserService userService) {
    ...
    @PostMapping
    public ResponseEntity<PurchaseOption> savePurchaseOption(@RequestBody PurchaseOptionRequest purchaseOption, HttpServletRequest request) throws IOException {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(purchaseOptionService.savePurchaseOption(purchaseOptionToSave));
    }
